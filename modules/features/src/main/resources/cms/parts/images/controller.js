...
var scaleOptions = [
    {name: 'Scale Max', value: 'scalemax(600)'},
    {name: 'Scale Wide', value: 'scalewide(600,200)'},
    {name: 'Scale Block V', value: 'scaleblock(600,200)'},
    {name: 'Scale Block H', value: 'scaleblock(200,600)'},
    {name: 'Scale Square', value: 'scalesquare(600)'},
    {name: 'Scale Width', value: 'scalewidth(600)'},
    {name: 'Scale Height', value: 'scaleheight(600)'}
];
